...
test('the speed rankings preserve their reviewed cutoffs and caveats', () => {
  const sprint = DISCOVER_RANKINGS.find(({ slug }) => slug === 'homens-mais-rapidos-100-metros');
  const animals = DISCOVER_RANKINGS.find(
    ({ slug }) => slug === 'animais-marinhos-maiores-velocidades-publicadas',
  );
