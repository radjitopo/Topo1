  ...
  'como-funciona': {
    ...
    content: `
      ...
      <section class="legalSection">
        ...
        <ul><li>Até 10 opções votadas em cada ranking.</li><li>Até 30 votos sem cadastro; depois, pedimos acesso por e-mail.</li><li>Um voto ativo por opção e por pessoa ou dispositivo vinculado.</li><li>Votos duplos são liberados conforme a participação e valem dois pontos.</li><li>O Top 10 aparece primeiro; listas maiores podem ser abertas até o Top 20.</li></ul>
      </section>
      <section class="legalSection">
...
<link rel="stylesheet" href="/style.css?v=20260823-3">
</head>
