...
function footerHtml() {
  return `<footer class="siteFooter">
    <div class="wrap siteFooterGrid">
      <div class="siteFooterIntro"><a class="siteFooterBrand" href="/" aria-label="TOPO — ir para a home"><img src="/logo-topo-footer-v6.svg" alt="TOPO" width="184" height="54"></a><p>Tudo vira ranking. Vote, descubra e mude a ordem.</p></div>
...
<meta property="og:title" content="${escapeHtml(title)}"><meta property="og:description" content="${escapeHtml(page.description)}"><meta property="og:url" content="${escapeHtml(canonical)}"><meta property="og:image" content="${BASE_URL}/og-topo-v4.png">
<meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="${escapeHtml(title)}"><meta name="twitter:description" content="${escapeHtml(page.description)}"><meta name="twitter:image" content="${BASE_URL}/og-topo-v4.png">
<script type="application/ld+json">${structuredData}</script>
<meta name="theme-color" content="#fffdf8">
<link rel="icon" href="/topo-mark-v6.svg" type="image/svg+xml">
...
<header class="legalTop"><div class="wrap"><a class="logo" href="/" aria-label="TOPO — ir para a home"><img src="/logo-topo-v6.svg" alt="TOPO" width="184" height="54"></a><a class="legalBack" href="/">← Voltar aos rankings</a></div></header>
