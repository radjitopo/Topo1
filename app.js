...
function renderDiscoverPage() {
  ...
  feed.innerHTML = `<section class="portalEmpty"><h1>Rankings</h1><p>Abra novamente a seção para carregar os rankings editoriais.</p><a class="categoryVoteCta" href="/rankings">Ver os 120 rankings →</a></section>`;
}
