...
function discoverHomeCalloutHTML() {
  return `<section class="discoverHomeCallout" aria-labelledby="discover-home-title"><header><div><span class="discoverEyebrow">RANKINGS EDITORIAIS</span><h2 id="discover-home-title">Rankings</h2><p>Informação clara, números reais, data e fonte — sem votação.</p></div><a href="/rankings">VER OS 52 RANKINGS →</a></header><div class="discoverHomePreview"><span class="discoverStatus">52 PUBLICADOS</span><div><h3>Das maiores fortunas às celebridades e aos recordes do esporte.</h3><p>Top 10 completo, com o valor de cada posição.</p></div><a href="/rankings" aria-label="Abrir Rankings">↗</a></div></section>`;
}
