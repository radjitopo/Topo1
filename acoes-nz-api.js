...
const CRYPTO_STOCKS = [
  ...
  { ticker: 'SUI', symbol: 'SUI20947-USD', name: 'Sui' },
  { ticker: 'TON', symbol: 'TON11419-USD', name: 'Toncoin' },
  ...
  { ticker: 'PEPE', symbol: 'PEPE24478-USD', name: 'Pepe' },
  ...
  { ticker: 'POL', symbol: 'POL28321-USD', name: 'POL' },
  { ticker: 'ATOM', symbol: 'ATOM-USD', name: 'Cosmos' },
  { ticker: 'FIL', symbol: 'FIL-USD', name: 'Filecoin' },
  { ticker: 'APT', symbol: 'APT21794-USD', name: 'Aptos' },
  { ticker: 'ARB', symbol: 'ARB11841-USD', name: 'Arbitrum' },
];
