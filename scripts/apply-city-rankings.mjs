...
const rankings = [
  ...
  ranking(
    'cafes-floripa',
    'Florianópolis',
    'Qual café serve a melhor pausa de Florianópolis?',
    'cafe',
    [
      'Pão da Leli',
      'Arbor Café',
      ...
      'Café Decor',
      'Sehat',
      'Garapuvu Café & Bistrô',
      'Stazione Café',
      'Brulée Cafeteria & Doces Gourmet',
      'Arabesque Cafeteria e Restaurante',
      'Sabrosa Pizzaria, Bar e Café',
      'Coffee Liuk',
    ],
  ),
  ranking(
    'restaurantes-veganos-floripa',
    'Florianópolis',
    'Qual é o melhor restaurante vegano de Florianópolis?',
    'vegan',
    [
      'Porongo',
      'Espaço Nutrir – Lagoa da Conceição',
      'Libre Cozinha',
      'Ahimsa Burgers',
      'Tsan The Restaurante Natural',
      'Caapora – Espaço de Culturas',
      'Mamma Veg – Estreito',
      'Canteiro',
      'Refeitório Vegano',
      'Fermentaria',
